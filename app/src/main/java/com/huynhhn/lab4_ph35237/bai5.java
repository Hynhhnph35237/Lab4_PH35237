...
public class bai5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button bnt = findViewById(R.id.btn_login);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button bnt1 = findViewById(R.id.btn_dk);
        bnt1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(bai5.this,bai6.class);
